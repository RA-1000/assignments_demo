...
//    @AfterThrowing(pointcut = "execution(* com.santander.parking.repository.impl.*.*(..)))", throwing = "ex")
//    public void logDataAccessException(JoinPoint joinPoint, BaseException ex) throws Throwable {
//    	log.error("Error in: {}.{}()", joinPoint.getSignature().getDeclaringTypeName(), 
//    			joinPoint.getSignature().getName(), ex);
//    }
}
